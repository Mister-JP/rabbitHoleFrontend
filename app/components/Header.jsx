...
const Header = () => {
  ...
  return (
    <div className="m-5 ml-5 mx-auto flex space-between items-center">
        ...
        <nav className="flex space-x-6">
          ...
          <Link href="/login" className="py-2 px-4 rounded border border-black rounded-full hover:bg-white hover:text-indigo-600 transition duration-200">Login</Link>
          <Link href="/register" className="py-2 px-4 rounded border border-black rounded-full hover:bg-white hover:text-indigo-600 transition duration-200">Register</Link>
        </nav>
      </div>
  );
}
